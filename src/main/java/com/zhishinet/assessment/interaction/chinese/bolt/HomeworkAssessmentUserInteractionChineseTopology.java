package com.zhishinet.assessment.interaction.chinese.bolt;
...
import com.zhishinet.assessment.interaction.chinese.Field;
...
public class HomeworkAssessmentUserInteractionChineseTopology {

    private final static ObjectMapper mapper = new ObjectMapper();
    private static final String TOPIC = "HomeworkAssessmentUserInteractionChinese";
    public static final String SPOUTID = "homeworkassessmentuserinteractionchinesestorm";
    ...
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
        ...
        FileNameFormat fileNameFormat = new DefaultFileNameFormat().withPath("/tmp/storm/HomeworkAssessmentUserInteractionChinese/").withExtension(".txt");
